				...
				<form
					...
					<div className="logistics-quotation-small-inputs">
						...
						<div className="logistics-quotation-small-input-group">
							...
							{formik.touched.warehousetype &&
							formik.errors.warehousetype ? (
								<div className="error">
									{formik.errors.warehousetype}
								</div>
							) : null}
...
export default StorageEditFormsContent;
